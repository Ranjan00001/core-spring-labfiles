...
public class JdbcAccountRepository implements AccountRepository {
	...
	private ResultSetExtractor<Account> accountResultSetExtractor = new AccountResultSetExtractor();
	...
	public Account findByCreditCard(String creditCardNumber) {
		...
		Account account = jdbcTemplate.query(sql, accountResultSetExtractor, creditCardNumber);
...
//		}
	...
	public void updateBeneficiaries(Account account) {
		...
		for (Beneficiary beneficiary: account.getBeneficiaries()) {
			jdbcTemplate.update(sql, beneficiary.getSavings().asBigDecimal(), beneficiary.getEntityId(), beneficiary.getName());
		}
//		Connection conn = null;
//		PreparedStatement ps = null;
//		try {
